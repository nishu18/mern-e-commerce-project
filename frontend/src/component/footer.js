...
//     <div className="text">Fully Responsive Footer Section</div>
//     <div className="p">HTML and CSS (Flexbox)</div>
//   </div>
//   <footer>
...
//       <center>
//         <span className="credit">Created By <a href="https://www.codingnepalweb.com">CodingNepal</a> | </span>
